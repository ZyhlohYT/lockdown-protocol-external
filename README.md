# Created By [psZachary](https://github.com/psZachary/) ALL CREDIT to them for the tool I simply updated the GUI, font, and added a few features.
...
- **ESP Details**
   ...
   - [NEW] Hide Empty Weapons (Hides Weapon's ESP When It Has 0 Ammo)
- **Player Hacks**
   - Speed Hack
   - God Mode
   - Infinite Stamina
...
1. **Clone the Repository**:
   ```bash
   git clone https://github.com/ZyhlohYT/lockdown-protocol-external.git
