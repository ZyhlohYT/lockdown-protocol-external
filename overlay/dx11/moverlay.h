#include "../overlay.h"
#include "../globals.h"
#include "../../fonts/inter_bold_font.h"
...
public:
    ...
    void load_font() {
        ...
        cfg.PixelSnapH = true;
        cfg.FontDataOwnedByAtlas = false; // Important: ImGui will not free the font data
        ...
        default_font.im_font = io.Fonts->AddFontFromMemoryTTF(
            (void*)inter_bold_font_data,  // Font data from the generated header
            inter_bold_font_data_size,    // Font data size
            14.0f,                        // Font size
            &cfg,                         // Font config
        ...
        if (default_font.im_font == nullptr) {
            std::cout << "Failed to load Inter Bold font, trying default font" << std::endl;
        ...
        std::cout << "Font atlas built successfully: " << width << "x" << height << std::endl;
    }
